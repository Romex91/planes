...
template <typename Archive>
void rplanes::network::servermessages::room::ÑreateRicochetes::serialize( Archive& ar, const unsigned int version )
{
	ar & bullets;
	ar & time;
}
...
template <typename Archive>
void rplanes::network::servermessages::room::ÑreateMissiles::serialize( Archive& ar, const unsigned int version )
{
	ar & missiles;
	ar & time;
}
